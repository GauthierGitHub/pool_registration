<?php
	...
	if($pool_services_lite_resp_stickyheader == true && get_theme_mod( 'pool_services_lite_sticky_header',false) != true){
    	$pool_services_lite_custom_css .='.header-fixed{';
			$pool_services_lite_custom_css .='position:static;';
		$pool_services_lite_custom_css .='} ';
	}
    if($pool_services_lite_resp_stickyheader == true){
    	$pool_services_lite_custom_css .='@media screen and (max-width:575px) {';
		$pool_services_lite_custom_css .='.header-fixed{';
			$pool_services_lite_custom_css .='position:fixed;';
		$pool_services_lite_custom_css .='} }';
	...
	if($pool_services_lite_resp_slider == true && get_theme_mod( 'pool_services_lite_slider_arrows', false) == false){
	...
	if($pool_services_lite_resp_scroll_top == true && get_theme_mod( 'pool_services_lite_hide_show_scroll',true) != true){
    	$pool_services_lite_custom_css .='.scrollup i{';
			$pool_services_lite_custom_css .='visibility:hidden !important;';
		$pool_services_lite_custom_css .='} ';
	}
    if($pool_services_lite_resp_scroll_top == true){
    	$pool_services_lite_custom_css .='@media screen and (max-width:575px) {';
		$pool_services_lite_custom_css .='.scrollup i{';
			$pool_services_lite_custom_css .='visibility:visible !important;';
		$pool_services_lite_custom_css .='} }';
	...
	$pool_services_lite_preloader_bg_color = get_theme_mod('pool_services_lite_preloader_bg_color');
	if($pool_services_lite_preloader_bg_color != false){
		$pool_services_lite_custom_css .='#preloader{';
			$pool_services_lite_custom_css .='background-color: '.esc_attr($pool_services_lite_preloader_bg_color).';';
		$pool_services_lite_custom_css .='}';
	}

	$pool_services_lite_preloader_border_color = get_theme_mod('pool_services_lite_preloader_border_color');
	if($pool_services_lite_preloader_border_color != false){
		$pool_services_lite_custom_css .='.loader-line{';
			$pool_services_lite_custom_css .='border-color: '.esc_attr($pool_services_lite_preloader_border_color).'!important;';
		$pool_services_lite_custom_css .='}';
	}