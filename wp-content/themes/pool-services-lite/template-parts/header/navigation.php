...
<div class="header-menu <?php if( get_theme_mod( 'pool_services_lite_sticky_header', false) != '' || get_theme_mod( 'pool_services_lite_stickyheader_hide_show', false) != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
  <div class="container">
