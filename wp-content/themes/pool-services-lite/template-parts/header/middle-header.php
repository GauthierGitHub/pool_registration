...
<div class="middle-header">
	<div class="container">
				    	...
				    	<div class="row info-ctr">
				    		<?php if( get_theme_mod( 'pool_services_lite_phone_text') != '' || get_theme_mod( 'pool_services_lite_phone_number') != '') { ?>
				          	...
				          	<div class="col-lg-9 col-md-9 col-9">
				            	...
				            	<p><a href="tel:<?php echo esc_url( get_theme_mod('pool_services_lite_phone_number','') ); ?>"><?php echo esc_html(get_theme_mod('pool_services_lite_phone_number',''));?></a></p>
				          	</div>
				      		<?php }?>
				    	</div>
				    </div>
		    		...
		    		<?php if( get_theme_mod( 'pool_services_lite_search_enable',true) != '' ) { ?>
			    		<div class="col-lg-1 col-md-1">
			    			<div class="search-box">
			                	<span><a href="#"><i class="<?php echo esc_attr(get_theme_mod('pool_services_lite_search_icon','fas fa-search')); ?>"></i></a></span>
			              </div>
		    			</div>
		    		<?php }?>
		    	</div>
		...
		<div class="serach_outer">
	        <div class="closepop"><a href="#maincontent"><i class="<?php echo esc_attr(get_theme_mod('pool_services_lite_search_close_icon','fa fa-window-close')); ?>"></i></a></div>
