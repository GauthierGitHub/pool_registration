          ...
          <?php if( get_theme_mod( 'pool_services_lite_toggle_postdate',true) != '' || get_theme_mod( 'pool_services_lite_toggle_author',true) != '' || get_theme_mod( 'pool_services_lite_toggle_comments',true) != '') { ?>
            <div class="post-info">
              ...
              <?php if(get_theme_mod('pool_services_lite_toggle_comments',true)==1){ ?>
                <i class="fa fa-comments" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'pool-services-lite'), __('0 Comments', 'pool-services-lite'), __('% Comments', 'pool-services-lite') ); ?> </span><span>|</span>
              <?php } ?>

              <?php if(get_theme_mod('pool_services_lite_toggle_time',true)==1){ ?>
